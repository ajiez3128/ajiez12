...
# Author  : Yth Ajiez
# (C) Copyright 2021-2022 By Ajiez Vandelas
# =========================================
...
echo -e "         OWNER : ${GREEN}Ajiez vpn ${NC}${YELLOW}(${NC} ${GREEN}ajiez_vandelas ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By Ajiez_Vandelas ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
